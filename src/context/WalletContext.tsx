  ...
  const value: WalletContextType = useMemo(
    () => ({
      ...
      isSyncing:
        ...
        walletData.isLoadingTokens ||
        txHistory.isLoadingMore,
      network: appInit.settings?.network || "mainnet",
    ...
    [
      walletState.wallet,
      walletState.wallets,
      walletState.activeWalletIndex,
      walletState.pendingWallet,
      walletState.setActiveWallet,
      walletState.setActiveWalletIdx,
      walletState.handleAddWallet,
      walletState.handleUpdateWalletName,
      walletState.deleteWallet,
      walletState.setWallets,
      walletState.setPendingWallet,
      ...
      walletData.isRefreshing,
      walletData.isLoadingTokens,
      walletData.refreshAll,
      walletData.setBalance,
      walletData.setNonce,

      txHistory.transactions,
      txHistory.isLoadingMore,
      txHistory.hasMoreTxs,
      txHistory.refreshTransactions,
      txHistory.setTransactions,
      txHistory.loadMoreTransactions,

      appInit.settings,
      appInit.view,
      appInit.setView,
      appInit.setSettingsState,
      appInit.initializeApp,
      appInit.updateSettings,
    ],
  );
