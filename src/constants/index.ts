 ...
 */
export const getExplorerUrl = (type: 'tx' | 'address', value: string, network: 'mainnet' | 'testnet' = 'testnet') => {
    const base = network === 'mainnet' ? NETWORKS.MAINNET.explorer : NETWORKS.TESTNET.explorer;
