/**
 * OSM-1 Implementation for Qiubit Wallet
 * Qiubit Sign Message Standard
 */
...
// BASE58_ALPHABET removed (consolidated in crypto.ts)
...
// Re-export or wrap crypto functions for compatibility
export { base58Encode };
...
export async function verifyOSM1Signature(
    response: { payload: OSM1Payload; signature: string; publicKey: string; address: string },
    nacl: any,
