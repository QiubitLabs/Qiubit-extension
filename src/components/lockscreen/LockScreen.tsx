...
export function LockScreen({ onUnlock, onRecover }: LockScreenProps) {
  ...
  const [recoveryMethod, setRecoveryMethod] = useState<"phrase" | "key" | null>(
    null,
  );
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = securityService.recordPasswordAttempt(
        false,
      ) as SecurityResult;
  ...
  const handleRecovery = async (e: React.FormEvent) => {
    ...
    if (!recoveryInput.trim()) {
      setRecoveryError(
        `Please enter your ${recoveryMethod === "phrase" ? "recovery phrase" : "private key"}`,
      );
      return;
    }
    ...
    try {
      ...
      setRecoveryError(
        err.message || "Recovery failed. Please check your input.",
      );
    } finally {
  ...
  const confirmReset = async () => {
    ...
    try {
      await storage.clear();
      logInfo("[LockScreen] [OK] All data cleared");

      logInfo("[LockScreen] [OK] All data cleared, reloading...");

      window.location.reload();
    } catch (error) {
      console.error("[LockScreen] [ERROR] Failed to clear data:", error);
      window.location.reload();
    }
  };
        ...
        <div className="lock-screen-content">
          ...
          <div className="recovery-options">
            ...
            >
              ...
              <div className="recovery-option-text">
                ...
                <span className="recovery-option-desc">
                  Use your 12-word phrase
                </span>
              </div>
            </button>
            <button
          ...
          >
            <div className="recovery-option-text">
              ...
              <span
                className="recovery-option-desc recovery-option-danger-desc"
                style={{ display: "flex", alignItems: "center", gap: "4px" }}
              >
                <WarningIcon size={14} /> Deletes current wallet permanently
              </span>
            </div>
          </button>
        </div>
      ...
      <div className="lock-screen animate-fade-in">
        <div className="lock-screen-content">
          ...
          <p className="lock-subtitle">
            Enter your credentials and create a new password
          </p>
              ...
              <div className="input-with-icon">
                <textarea
                  ...
                  placeholder={
                    recoveryMethod === "phrase"
                      ? "word1 word2 word3 ..."
                      : "Paste your private key (Base64)"
                  }
                  rows={3}
                  disabled={isRecovering}
                  style={{
                    fontFamily: showRecoveryInput ? "monospace" : "inherit",
                    filter: showRecoveryInput ? "none" : "blur(4px)",
                  }}
                />
                <button
                  type="button"
                ...
                <div className="password-strength">
                  <div className="password-strength-bar">
                    <div
                      ...
                      style={{
                        width: `${calculatePasswordStrength(newPassword).percent}%`,
                      }}
                    />
                  </div>
                  <span
                    className={`password-strength-text strength-${calculatePasswordStrength(newPassword).level}`}
                  >
    ...
    <div className="lock-screen animate-fade-in">
      <div className={`lock-screen-content ${isShaking ? "shake" : ""}`}>
        ...
        <div className="lock-branding">
          <QiubitLogo size={32} />
          <h1 className="lock-title">Qiubit</h1>
        </div>
    ...
    <div className="setup-password animate-fade-in">
      <div className="setup-password-header">
        ...
        <p className="setup-subtitle">
          Create a strong password to protect your wallet. You'll need this to
          unlock your wallet and export your keys.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="setup-form">
        ...
        >
          ...
          >
            ...
            />
            <span>
              <strong>Important:</strong> If you forget your password, you can
              only recover your wallet using your recovery phrase. Make sure to
              save it securely.
            </span>
          </p>
        </div>
