  ...
  return (
    <div className="da-body-content da-network-layout">
        ...
        <div className="da-card da-network-details-card">
          <div className="da-row">
            ...
            <span
              ...
              style={{ color: net?.badgeColor || "var(--text-primary)" }}
            >
      ...
      <div className="da-notice">
        <AlertIcon size={14} />
        <span>
          Beralih jaringan hanya mengubah rantai aktif tempat transaksi Anda
          diajukan. Saldo Anda akan secara otomatis tersegregasi di bawah
          jaringan baru.
        </span>
      </div>
    </div>
