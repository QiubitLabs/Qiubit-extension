...
export function AddNetworkModal({ network, origin, onAdd, onCancel, isLoading }: AddNetworkModalProps) {
        ...
        <div className="add-network-modal">
            <div className="add-network-header">
                <div className="add-network-site-icon">
                    {network.iconUrls?.[0] ? (
                        <img src={network.iconUrls[0]} alt={network.chainName} width={40} height={40} />
                    ) : (
            ...
            <div className="add-network-body">
                ...
                <div className="add-network-field">
                    ...
                    <span className="add-network-value">{chainIdDecimal} ({network.chainId})</span>
                </div>
                <div className="add-network-field">
                ...
                {explorerUrl && (
                    <div className="add-network-field">
                        ...
                        <span className="add-network-value add-network-mono">{explorerUrl}</span>
                    </div>
                )}
                ...
                <div className="add-network-warning">
                    ...
                    <span>Only add networks from sources you trust. A malicious network can monitor and manipulate your transactions.</span>
                </div>
            </div>
            ...
            <div className="add-network-footer">
                ...
                <button className="btn btn-primary" onClick={onAdd} disabled={isLoading}>
