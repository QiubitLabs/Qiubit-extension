      ...
      <div className="modal shield-modal" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <div className="flex items-center gap-sm">
            <IconComponent
              size={20}
              className={isShield ? "text-accent" : "text-secondary"}
            />
...
export function PrivateTransferModal({
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div
        className="modal private-transfer-modal"
        ...
        <div className="modal-body">
          {step === 1 ? (
            <>
              ...
              <div className="shield-balance-info">
                <div className="shield-balance-row">
                  <span className="shield-balance-label">
                    Encrypted Balance:
                  </span>
...
export function ClaimTransfersModal({
  isOpen,
  onClose,
  pendingTransfers,
  onClaim,
  isLoading,
}: ClaimTransfersModalProps) {
