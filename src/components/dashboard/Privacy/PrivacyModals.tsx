...
export function ShieldModal({ isOpen, onClose, mode, balance, encryptedBalance, onSubmit }: ShieldModalProps) {
...
export function PrivateTransferModal({ isOpen, onClose, encryptedBalance, onSubmit }: PrivateTransferModalProps) {
 ...
 */
interface ClaimTransfersModalProps {
    isOpen: boolean;
    onClose: () => void;
    pendingTransfers: any[];
    onClaim: (transferId: string) => Promise<void>;
    isLoading: boolean;
}

export function ClaimTransfersModal({ isOpen, onClose, pendingTransfers, onClaim, isLoading }: ClaimTransfersModalProps) {
