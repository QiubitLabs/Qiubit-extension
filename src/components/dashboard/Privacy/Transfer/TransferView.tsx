...
import { PrivateTransferIcon, QiubitTokenLogo, CheckIcon, CloseIcon, ChevronLeftIcon } from '../../../shared/Icons';
        ...
        return (
            <div className="token-list-view animate-slide-in">
                <header className="view-header-minimal mb-lg">
                    <h3 className="text-sm font-semibold text-secondary uppercase tracking-wider">Select Token to Transfer Privately</h3>
                </header>
                {displayTokens.length === 0 ? (
                    <div className="empty-state py-xl">
                        <p className="text-secondary">No eligible tokens found for private transfer.</p>
                    </div>
                ) : (
                        ...
                        {displayTokens.map((token: any) => (
                            ...
                            >
                                <div className="token-icon-wrapper">
                                    {token.isNative ? <QiubitTokenLogo size={22} /> : <PrivateTransferIcon size={22} />}
                                </div>
            ...
            <div className="confirm-tx-page animate-fade-in relative">
                ...
                <div className="flex items-center justify-between mb-xl">
                    ...
                    <div className="flex items-center justify-center gap-xs flex-1 bg-surface px-md py-1 rounded-full mx-auto" style={{ maxWidth: 'fit-content' }}>
                        ...
                        <span className="font-bold text-sm tracking-wide">Private {selectedToken?.symbol}</span>
                    </div>
                    <button className="header-icon-btn" onClick={onBack} style={{ border: 'none', background: 'transparent' }}>
                        <CloseIcon size={24} />
                    </button>
                ...
                <div className="confirm-v2-title">
                    Confirm <span className="confirm-v2-title-highlight">Private Transfer</span>
                </div>
