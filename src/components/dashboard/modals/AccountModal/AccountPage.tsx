        ...
        <div className="account-page-menu">
          ...
          >
            ...
            <div>
              ...
              <div className="account-page-item-desc">
          ...
          <button className="account-page-item danger" onClick={onDelete}>
      ...
      {screen === "export-pw" && (
        <div className="account-page-export">
          <div className="account-page-warning">
            ...
            Never share your private key. Anyone with this key has full control
            of your wallet.
          </div>
          ...
          {pwError && (
            <p
              style={{ color: "var(--error)", fontSize: 12, marginBottom: 10 }}
            >
              {pwError}
            </p>
          )}
