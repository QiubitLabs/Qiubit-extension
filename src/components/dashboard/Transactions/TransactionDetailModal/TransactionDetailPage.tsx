...
export function TransactionDetailPage({
  ...
  // meaningful counterparty, and older records may hold a network id.
  ...
  const explorerBase =
    networkConfig?.blockExplorerUrl ?? "https://etherscan.io";
  const networkName =
  ...
  const addressExplorerUrl = isEvmTx
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="tx-status-hero">
        ...
        <div
          className={`tx-status-badge ${tx.status === "pending" ? "pending" : "confirmed"}`}
