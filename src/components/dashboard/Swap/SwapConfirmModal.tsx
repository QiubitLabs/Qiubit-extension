...
import { ChevronLeftIcon, CheckIcon, ChevronDownIcon } from '../../shared/Icons';
...
export function SwapConfirmModal({
    ...
    const hasFromContract = fromToken?.contractAddress &&
    ...
    const hasToContract = toToken?.contractAddress &&
            ...
            <div className="flow-card-unified" style={{ 
                ...
                <div style={{ 
                    ...
                    <div className="token-logo-wrap" style={{ 
                        ...
                        <TokenIcon symbol={fromSymbol} logoUrl={fromToken?.logoUrl} size={44} />
                    </div>
