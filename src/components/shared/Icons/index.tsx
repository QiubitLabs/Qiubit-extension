/**
 * SVG Icon Components for Qiubit Wallet
 */
...
export interface AnimatedLockIconProps extends IconProps {
    isLocked?: boolean;
}

// Qiubit Wallet Logo - Uses icon.svg
export const QiubitLogo: React.FC<IconProps> = ({ size = 24, className = '' }) => (
    <img
        src="/icon.svg"
        alt="Qiubit"
        width={size}
...
// Keep Qiubit logo (SVG version) for specific needs
export const QiubitLogoSVG: React.FC<IconProps> = ({ size = 24, className = '' }) => (
...
// Official Qiubit Token Logo from qiubit-repos
export const QiubitTokenLogo: React.FC<IconProps> = ({ size = 24, className = '' }) => (
...
export const ImportIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
export const AnimatedLockIcon: React.FC<AnimatedLockIconProps> = ({ size = 48, isLocked = false, className = '' }) => {
...
export const ArrowDownLeftIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
export const GenericTokenIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
        <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="2" />
...
// Staking icon
export const StakingIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
        <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="2" />
...
// Shield icon (elegant shield with minimal padlock)
export const ShieldIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
        <path d="M12 22C17 20 20 16 20 11V7L12 3L4 7V11C4 16 7 20 12 22Z" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
        <rect x="9.5" y="11.5" width="5" height="4" rx="1" stroke="currentColor" strokeWidth="0.8" />
        <path d="M10.8 11.5V10.2C10.8 9.5 11.3 9 12 9C12.7 9 13.2 9.5 13.2 10.2V11.5" stroke="currentColor" strokeWidth="0.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);

// Unshield icon (elegant dashed shield with open padlock)
export const UnshieldIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
        <path d="M12 22C17 20 20 16 20 11V7L12 3L4 7V11C4 16 7 20 12 22Z" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
        <rect x="9.5" y="11.5" width="5" height="4" rx="1" stroke="currentColor" strokeWidth="0.8" />
        <path d="M10.8 11.5V9.5C10.8 8 11.8 7 13.2 7C14.6 7 15.6 8 15.6 9.5V10.2" stroke="currentColor" strokeWidth="0.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);

// Private transfer icon (smooth paper plane with padlock in bottom-right)
export const PrivateTransferIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
        {/* Padlock "behind" the plane tail - moved lower to avoid overlap */}
        <g transform="translate(3, 15)">
            <rect x="0" y="2" width="5" height="4" rx="1" fill="var(--bg-card, #000)" stroke="currentColor" strokeWidth="0.8" />
            <path d="M1.3 2V1.2C1.3 0.5 1.8 0 2.5 0C3.2 0 3.7 0.5 3.7 1.2" stroke="currentColor" strokeWidth="0.8" strokeLinecap="round" strokeLinejoin="round" />
        </g>
...
export const PublicIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
// Bridge icon
export const BridgeIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
export const EarnIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
// Gas/Fuel icon
export const GasIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
// Signature icon
export const SignatureIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
export const LinkIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
        ...
        <path d="M19.07 4.929a4 4 0 010 5.656l-1.102 1.101" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M15.657 8.343l-1.414 1.414" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M8 12L12 8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);
