...
import { ChevronLeftIcon, EyeIcon, EyeOffIcon, CopyIcon, CheckIcon, KeyIcon, LockIcon } from '../../../shared/Icons';
                ...
                {!isVerified ? (
                    ...
                    <>
                        ...
                        <div className="recovery-notice">
                            <p>Write these words down on paper and keep them safe. Do not take a screenshot.</p>
                        </div>
                        ...
                        <div
                            ...
                            style={{
                                ...
                                userSelect: showPhrase ? 'none' : 'none', /* Prevent selecting when blurred */
