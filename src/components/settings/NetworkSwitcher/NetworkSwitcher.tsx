...
export function NetworkSwitcher({
  ...
  const currentNetwork =
    rawNetwork === "mainnet" || rawNetwork === "testnet" ? "all" : rawNetwork;
  ...
  const handleRemoveUserNetwork = async (
    chainIdDecimal: number,
    networkId: string,
  ) => {
    await removeUserNetwork(chainIdDecimal);
    setUserNetworks((prev) =>
      prev.filter((n) => n.chainIdDecimal !== chainIdDecimal),
    );
  ...
  const networkIds = Object.keys(NETWORK_REGISTRY).sort((a, b) => {
    const ma = NETWORK_REGISTRY[a],
      mb = NETWORK_REGISTRY[b];
      ...
      <div className="wallet-content">
        ...
        <div className="network-options">
            ...
            return (
              ...
              >
                ...
                <div className="network-option-meta">
                  ...
                  {meta.isTestnet && (
                    <span className="network-option-badge">Testnet</span>
                  )}
                </div>
                {isActive && (
                  <div className="network-active-indicator">
          ...
          {filteredUserNetworks.map((n, idx) => {
            ...
            const index =
              filteredNetworkIds.length + (showAllNetworks ? 1 : 0) + idx;
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {isActive && (
                    <div
                      className="network-active-indicator"
                ...
                <button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    handleRemoveUserNetwork(n.chainIdDecimal, config.id);
                  }}
                >
                  <svg
                    width="14"
