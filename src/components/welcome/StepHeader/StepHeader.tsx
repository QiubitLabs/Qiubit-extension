...
// import stepCompleteAnimation from '../animations/step-complete.json'; // REMOVED
...
// Sub-component
function StepIndicator({ stepNum, shouldAnimate, isActive, isCompleted, isLast }: StepIndicatorProps) {
    return (
        <React.Fragment>
            <div
